...
class URI {
    ...
    static void Main(string[] args) { 
      ...
      Console.WriteLine("TRIANGULO {0}", atr.ToString("F3")); 
 
      //b) a área do círculo de raio C. (pi = 3.14159) 
      double r = pi * (Math.Pow(c,2)); 
      Console.WriteLine("CIRCULO {0}", r.ToString("F3")); 
 
      //c) a área do trapézio que tem A e B por bases e C por altura. 
      double at = ((a + b) * c) / 2;    //a = (B+b).h/2 
      Console.WriteLine("TRAPEZIO {0}", at.ToString("F3")); 
             
      //d) a área do quadrado que tem lado B. 
      double aq = (b * b); 
      Console.WriteLine("QUADRADO {0}", aq.ToString("F3")); 

      //e) a área do retângulo que tem lados A e B. 
      double ar = (a * b); 
      Console.WriteLine("RETANGULO {0}", ar.ToString("F3")); 
